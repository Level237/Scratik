    ...
    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            {data.map((campaign)=>{
                ...
                return (
                    <tr key={campaign._id} className=" odd:dark:bg-gray-900 text-white even:bg-[#ffffff10] even:dark:bg-gray-800  ">
...
<div className="mt-12 flex items-center justify-center mb-12">
    <h2 className="text-gray-500">Pas de campagnes</h2>
</div>
}
</div>
  )
