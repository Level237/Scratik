...
import { winning } from "@/data/winning/winning";
    ...
    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            {data.map((winning:{
                ...
                return (
                    <tr key={winning._id} className=" odd:dark:bg-gray-900 text-white even:bg-[#ffffff10] even:dark:bg-gray-800  ">
                                    ...
                                    <td className="px-6 py-4">
                                        <Image src={winning.image} width={30} height={30} alt={""}/>
